...
class Media {
  ...
  update(scroll, direction) {
    ...
    const isDesktop = this.screen.width >= 768;
    const effectiveBend = isDesktop ? this.bend * 1.5 : this.bend;
  ...
  onResize({ screen, viewport } = {}) {
    ...
    if (isMobile) {
      ...
      this.plane.scale.y =
        (this.viewport.height * (380 * this.scale)) / this.screen.height;
      this.plane.scale.x =
      ...
      this.plane.scale.y =
        (this.viewport.height * (420 * this.scale)) / this.screen.height;
      this.plane.scale.x =
        (this.viewport.width * (320 * this.scale)) / this.screen.width;
      this.padding = 1.6;
    }
