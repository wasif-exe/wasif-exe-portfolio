// src/pages/components/InfiniteMenu.js
...
const defaultItems = [
  {
    ...
    link: "https://github.com/wasif-exe",
    title: "Projects",
...
export default function InfiniteMenu({ items = [] }) {
  ...
  useEffect(() => {
    ...
    if (canvas) {
      sketch = new InfiniteGridMenu(
        ...
        (sk) => {
          sk.run();
          raf = requestAnimationFrame(() => sk.resize());
        }
      );
    }
  ...
  return (
    <div className="infinite-menu-container">
      ...
      {activeItem && (
        <div className={`menu-content ${isMoving ? "inactive" : "active"}`}>
